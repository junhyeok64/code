  <body class="h-100">
            ...
            <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
              <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 25px;">
                <div class="d-table m-auto">
                  <img id="main-logo" class="d-inline-block align-top mr-1" style="max-width: 25px;" src="<?=img_url?>/shards-dashboards-logo.svg" alt="Shards Dashboard">
              ...
              <ul class="navbar-nav border-left flex-row ">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <img class="user-avatar rounded-circle mr-2" src="<?=img_url?>/avatars/0.jpg" alt="User Avatar">
                ...
                <div class="card card-small mb-4">
                  ...
                  <div style="display:flex;">
                    <?php
                      switch($set_type) {
                        case "month_set":
                          //$input_name = array("smonth", "emonth");
                          $input_name = array("sdate", "edate");
                        break;
                        case "date_set":
                        default:
                          $input_name = array("sdate", "edate");
                    ...
                    ?>
                    <style type="text/css">
                      <?php if($set_type == "month_set") { echo "table.ui-datepicker-calendar { display:none; }"; }  ?>
                    </style>
                    <form name='tform' style="width:80%">
                      <input type="text" class="form-control <?=$set_type?>" id="" name="<?=$input_name[0]?>" style="width:30%;" maxlenght="<?=$maxlength?>" value="<?=$sdate?>">
                      <input type="text" class="form-control <?=$set_type?>" id="" name="<?=$input_name[1]?>" style="width:30%;margin-left:5px;" maxlenght="<?=$maxlength?>" value="<?=$edate?>">
                    </form>
                    <input type="button" value="submit" onclick="$('form[name=tform]').submit();">
                    <input type="button" id="" value="pop_test" onclick="etc.popup_test()">
                    <input type="button" id="" value="pop_test2" onclick="javascript:$('.popup').show();">
                    <div id="pop_test"></div>
                  </div>
    ...
    <div class="popup">
      <p style="float:right;cursor:pointer;margin:0 15px; font-size:25px;" onclick="$('.popup').hide();">X</p>
      <div style="clear:both">
        <input type="button" value="hi" onclick="$('input[name=sdate]').val('aa');">
      </div>
    </div>